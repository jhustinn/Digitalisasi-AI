...
interface NetlifyWorkingButtonProps {
...
export function NetlifyWorkingButton({
  variant = 'primary',
  size = 'md',
  showIcon = true,
  children,
  ...
  const handleWorkingDeploy = async () => {
    ...
    try {
      ...
      console.error('Working deploy error:', error);
...
// Quick working deploy button
export function NetlifyQuickWorkingButton() {
  return (
    <NetlifyWorkingButton
      variant="primary"
      size="md"
    >
      Deploy to Netlify
...
// Advanced working deploy button
export function NetlifyAdvancedWorkingButton({ siteName }: { siteName?: string }) {
  return (
    <NetlifyWorkingButton
      variant="secondary"
      size="lg"
