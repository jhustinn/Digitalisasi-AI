...
interface NetlifyFunctionalButtonProps {
...
export function NetlifyFunctionalButton({
  variant = 'primary',
  size = 'md',
  showIcon = true,
  children,
  ...
  const handleFunctionalDeploy = async () => {
    ...
    try {
      ...
      console.error('Functional deploy error:', error);
  ...
  return (
    <div className="flex flex-col items-center">
      <button
        ...
        onClick={handleFunctionalDeploy}
...
// Quick functional deploy button
export function NetlifyQuickFunctionalButton() {
  return (
    <NetlifyFunctionalButton
      variant="primary"
      size="md"
    >
      Deploy to Netlify
...
// Advanced functional deploy button
export function NetlifyAdvancedFunctionalButton({ siteName }: { siteName?: string }) {
  return (
    <NetlifyFunctionalButton
      variant="secondary"
      size="lg"
