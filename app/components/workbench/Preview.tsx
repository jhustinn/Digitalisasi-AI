              ...
              <>
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-white dark:bg-black rounded-xl shadow-2xl border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)] overflow-hidden">
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                            showDeviceFrame ? 'bg-[#3B82F6]' : 'bg-gray-300 dark:bg-gray-700'
                          } relative`}
                          onClick={(e) => {
                            e.stopPropagation();
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                            isLandscape ? 'bg-[#3B82F6]' : 'bg-gray-300 dark:bg-gray-700'
                          } relative`}
                          onClick={(e) => {
                            e.stopPropagation();
                  ...
                  {WINDOW_SIZES.map((size) => (
                    ...
                    >
                      <div
                        className={`${size.icon} w-5 h-5 text-[#6B7280] dark:text-gray-400 group-hover:text-[#3B82F6] dark:group-hover:text-[#3B82F6] transition-colors duration-200`}
                      />
                      <div className="flex-grow flex flex-col">
                                                  <span className="font-medium group-hover:text-[#3B82F6] dark:group-hover:text-[#3B82F6] transition-colors duration-200">
                          {size.name}
                        </span>
                                                  <span className="text-xs text-[#6B7280] dark:text-gray-400 group-hover:text-[#3B82F6] dark:group-hover:text-[#3B82F6] transition-colors duration-200">
                      ...
                      {selectedWindowSize.name === size.name && (
                        <div className="text-[#3B82F6] dark:text-[#3B82F6]">
                          <svg
